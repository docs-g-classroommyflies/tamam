...
( () => {
    ...
    var e = {
        ...
        719: (e, t, n) => {
            ...
            const o = ["GameplayAPI", "LoadingAPI", "PluginEngineDataReporterAPI"]
              , s = "achv-manager"
              , i = "game_api";
            var c, l = ((c = l || {}).Pause = `${i}_pause`,
            c.Resume = `${i}_resume`,
            c);
            const d = "gameplay_api";
            var u, h = ((u = h || {}).Start = `${d}_start`,
            u.Stop = `${d}_stop`,
            u);
            const p = "-on-body"
              , m = "screen_recorder"
            ...
            e))(y || {});
            const f = "sdk-event";
            var v = (e => (e.BONUS_AWARDED = "BONUS_AWARDED",
            e.EXIT = "EXIT",
        ...
        754: (e, t, n) => {
            ...
            function c(e, t={}) {
                s("sdk-game", e, t),
                "warn" === t.level ? console.warn(e, r.X4) : console.error(e, r.X4)
            }
        }
        ,
        998: (e, t, n) => {
            ...
            function m(e, t, n) {
                ...
                return c = i.message,
                p.some((e => e.test(c))) ? null : (n.message && (i.message = n.message),
                n.prefix && (i.message = `${n.prefix} ${i.message}`),
                {
                    ...
                    source: e,
                    sourceMethod: null != (o = n.sourceMethod) ? o : (0,
                    r.Z)(i.stack),
        ...
        498: (e, t, n) => {
            ...
            function a() {
                ...
                return n || (0,
                r.f)(new Error("Can not get appId from environment")),
                n
            }
        }
        ,
        ...
        89: (e, t, n) => {
            ...
            class o {
                ...
                getExternalCallback(e) {
                    const {type: t, action: n, messageId: r, payload: a} = e.data || {};
                    return this.callbacks[r] || (this.callbacks[r] = (e={}) => {
                        const o = {
                            type: e.type || t,
                            action: e.action || n,
                            originMessageId: r,
                ...
                handleEvent(e) {
                    const {type: t, action: n, originMessageId: r, originPayload: a, data: o, error: s, errorJSON: i} = e.data || {}
                      , c = this.promises[r];
                    c && (this.deletePromise(r),
                    void 0 === s ? c.resolve({
                        type: t,
                        action: n,
                        originPayload: a,
    ...
    ( () => {
        ...
        e))(e || {});
        const t = e => {
            const {async: t, content: n, crossOrigin: r, id: a, nonce: o, onErrCb: s, onLoadCb: i, src: c} = e
        ...
        class f {
            constructor(e) {
                ...
                this.unsubscribe = (e, t) => {
                    ...
                    if (!r)
                        return void (null == (n = this.log) || n.call(this, `Observable: eventId {${e}} does not exist`));
                    const a = r.indexOf(t);
                    -1 !== a && r.splice(a, 1)
                }
                ,
        ...
        const w = {
          ...
          , b = class {
            constructor() {
                ...
                this.setProgress = (e, t) => v(this, null, (function*() {
                ...
                this.post = e => v(this, null, (function*() {
                    ...
                    return l.F.postToParent(e).then((t => {
                        ...
                        return a && r ? (this.notify(e.action, null != (n = e.data) ? n : {}, r),
        ...
        ;
        b.init = () => {
            const {getList: e, getProgress: t, off: n, on: r, setProgress: a} = new b;
            return {
                getList: e,
                getProgress: t,
                off: n,
        ...
        ;
        let P = b;
        var E = (e => (e.ADV_IS_NOT_CONNECTED = "ADV_IS_NOT_CONNECTED",
        e.UNKNOWN = "UNKNOWN",
        e))(E || {});
        const S = h("NoAds", "Adv")
        ...
        function x(e, t) {
            return "function" == typeof e[t] ? (n = e[t],
        ...
        class C {
            constructor(e) {
                ...
                this.onAdvManagerExternalMessage = e => {
                    var t, n, r, a, o, s, i, c, l, d, u, h, p;
                    const {action: g, data: y} = e.data;
                    switch (I(`onAdvManagerExternalMessage ${g}`),
                    g) {
                    ...
                    case "set-disabled-state":
                        I('On "set-disabled-state" event', e.data, y.value),
                ...
                (null == (t = window.YandexGamesSDKEnvironment) ? void 0 : t.isWorldWide) && this.setDisabledState(!0),
                ...
                l.F.onExternalMessage("adv-manager", this.onAdvManagerExternalMessage),
                l.F.onExternalMessage("adv-debug-manager", this.onAdvDebugManagerExternalMessage),
                this.updateDisabledState()
            }
            checkDeprecatedOnAdvCloseUsage() {
                "onAdvClose"in this.adv && (0,
                m.T)(new Error('Deprecated usage "onAdvClose". Please, use `ysdk.adv.method({callbacks})` https://yandex.ru/dev/games/doc/sdk/sdk-adv'))
            }
            ...
            switchStickyBannersDebug(e) {
                this.getBannerAdvStatus().then(( ({stickyAdvIsShowing: t}) => {
                    t ? this.hideBannerAdv().then(( ({stickyAdvIsShowing: t}) => {
                        ...
                        I(`${e} hideBannerAdv, stickyAdvIsShowing = ${n}, reason = ${t}`)
                    }
                    ))
                }
                ))
            ...
            updateDisabledState() {
                l.F.postToParent(i.X$.GetDisabledState()).then(( ({data: e}) => {
                    this.setDisabledState(e.value)
                }
                )).catch(console.warn)
            }
            setDisabledState(e) {
                I("setDisabledState", e),
                e ? A || (A = !0,
                S("_disableAds"),
                function() {
                    var e;
                ...
                function() {
                    ...
                    Object.defineProperty(window, "Ya", {
                        get() {
                            var e;
                            return (null == (e = null == a ? void 0 : a.Context) ? void 0 : e.AdvManager) && a.Context.AdvManager !== r && (a.Context.AdvManager = r),
                            T(),
                            a
                        },
                        set(e) {
            ...
            ensureCallbacksIsValid(e, t) {
                ...
                try {
                    ...
                    (0,
                    m.T)(new Error('Error in "ensureCallbacksIsValid"'), {
                        additional: {
            ...
            showFullscreenAdv({callbacks: e={}}={}) {
                ...
                l.F.postToParent(i.X$.AdvShowFullscreen()).then(( ({data: {error: t}}) => {
                    if (!t)
                        return this.setCallbacks(e, ["onClose", "onOpen", "onError"]);
                    if (D() && t.message.includes("often than once per"))
                        throw t;
                    (0,
                    m.T)(t, {
                        level: "warn"
            ...
            showRewardedVideo({callbacks: e={}}={}) {
                ...
                l.F.postToParent(i.X$.AdvShowRewardedVideo()).then(( ({data: {error: t}}) => {
                    if (t)
                        throw t;
            ...
            showBannerAdv() {
                return new Promise((e => {
                    ...
                    l.F.postToParent(i.X$.AdvShowStickyBanner()).then(( ({data: t}) => {
                        e(t)
                    }
                    )).catch((t => {
                        (0,
            ...
            hideBannerAdv() {
                return new Promise((e => {
                    ...
                    l.F.postToParent(i.X$.AdvHideStickyBanner()).then(( ({data: t}) => {
                        e(t)
                    }
                    )).catch((t => {
                        (0,
            ...
            getBannerAdvStatus() {
                return new Promise((e => {
                    ...
                    l.F.postToParent(i.X$.AdvStatusStickyBanner()).then(( ({data: t}) => {
                        e(t)
                    }
                    )).catch((t => {
                        (0,
        ...
        class M {
            ...
            getID() {
                ...
                F.sendOnceDeprecatedUsage("Player.getID"),
            ...
            getPayingStatus() {
                return l.F.postToParent(i.yH.GetGamePurchaseEnabled()).then(( ({data: {enabled: e}}) => {
                    e || (0,
                    m.T)(new Error("We provide data on the player's ability to pay in games that already support purchases"), {
                        level: "warn"
                    })
                }
                )),
            ...
            getPhoto(e="medium") {
                ...
                return this._personalInfo.avatarIdHash ? `${function() {
                    var e, t, n;
                    if (G.sdkBackendURL)
                        return G.sdkBackendURL;
                    (0,
                    m.f)(new Error("still using process.env.SDK_BACKEND_URL"));
                    const r = (null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.serviceHostname) || (null == (t = window.YandexGamesSDKEnvironment) ? void 0 : t.serviceName) || "yandex"
                      , a = (null == (n = window.YandexGamesSDKEnvironment) ? void 0 : n.i18n.tld) || "ru";
                    return "https://games-sdk.%DOMAIN_NAME%.%TLD%/games/api/sdk/v1".replace(R.O6, r).replace(R.U0, a)
                }()}/player/avatar/${this._personalInfo.avatarIdHash}/${t}` : `${j}${R._h}/${t}`
            }
        }
        ...
        const ne = s((e => l.F.postToParent(i.S.Score(e)).then(( ({data: e}) => e.result))), 1e3);
        class re {
            ...
            getLeaderboardEntries(e, t) {
                const {includeUser: n=!1, quantityAround: r=5, quantityTop: a=5} = t || {}
                  , o = y("Leaderboards.getLeaderboardEntries")
                  , s = l.F.postToParent(i.S.Entries({
                    include_user: n,
                    name: e,
                    quantity_around: r,
                    quantity_top: a
            ...
            getLeaderboardPlayerEntry(e) {
                return t = this,
                n = function*() {
                    const {data: t} = yield l.F.postToParent(i.S.PlayerEntry({
                        name: e
                    }));
            ...
            setLeaderboardScore(e, t, n) {
                ...
                return this.lastTimeLeaderboardWasSend && !this.canSetLeaderboardScoreByTime() ? Promise.reject("The request to setLeaderboardScore can be sent no more than once per second") : (n && (r.extraData = n),
            ...
            transformLeaderboardEntry(e, t) {
                const {avatarIdHash: n, lang: r, publicName: a, scopePermissions: o, uniqueID: s} = e.player
                  , i = `${t}${n}`;
                return c = ( (e, t) => {
                    for (var n in t || (t = {}))
                        Z.call(t, n) && te(e, n, t[n]);
                    if (Q)
                        for (var n of Q(t))
                ...
                J(c, z({
                    player: {
                        getAvatarSrc: (e="medium") => (N[e] || (e = "medium"),
                        `${i}/${N[e]}`),
                        getAvatarSrcSet: (e="medium") => (N[e] || (e = "medium"),
                        `${i}/${N[e]} 1x, ${i}/${$[e]} 2x`),
                        lang: r,
                        publicName: a,
                        scopePermissions: o,
        ...
        class se extends Error {
            constructor({code: e, httpStatus: t, message: n}, r, a) {
                ...
                Error.captureStackTrace && Error.captureStackTrace(this, se)
            }
            toJSON() {
                return {
                    code: this.code,
        ...
        e))(le || {});
        const de = le.RU;
        function ue(e, t=de, n="") {
            if (e) {
                if ("string" == typeof e)
                    return e;
                if (t in e)
                    return e[t] || n;
                if (!(e => !e || ce.has(e))(t) && "en"in e)
                    return e.en || n;
                if (de in e)
                    return e[de] || n
            }
        ...
        var he;
        const pe = Symbol("codePath")
          , me = Symbol("appId")
          , ge = Symbol("sendMetricaParams")
          , ye = Symbol("currencyPriceStat")
        ...
        class be {
            ...
            get title() {
                return ue(this._productData.title)
            }
            get description() {
                return ue(this._productData.description)
            }
            get imageURI() {
            ...
            getPriceCurrencyImage(e="small") {
                if ("svg" === e)
                    return `${this[ve]()}/currency-icon-m.svg`;
                let t = "s";
                switch (e) {
                case "medium":
                case "small":
            ...
            [(he = fe,
            ve)]() {
                return `//yastatic.net/s3/games-static/static-data/images/payments/sdk${this[pe]}`
            }
            get[ye]() {
        ...
        const Pe = {}
          , Ee = (e="RUB", t="ru") => {
            const n = `${e}-${t}`;
            return Pe[n] || (Pe[n] = new Intl.NumberFormat(t,{
                currency: e,
                maximumFractionDigits: 2,
                minimumFractionDigits: 0,
                style: "currency",
                currencyDisplay: "KGS" === e ? "code" : "narrowSymbol"
            })),
            Pe[n]
        }
          , Se = e => {
        ...
        class Ae extends be {
            get priceCurrencyCode() {
                var e, t;
                return super.priceCurrencyCode,
                this[ye] ? ( (e="RUB", t="ru") => {
                    var n;
                    return (null == (n = Ee(e, t).formatToParts(1).find((e => "currency" === e.type))) ? void 0 : n.value) || e
                }
                )(this[ye].currency, null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.i18n.lang) : null == (t = window.YandexGamesSDKEnvironment) ? void 0 : t.moneyCodeSymbol
            }
            get price() {
                var e;
                return this[ye] ? ( (e, t="RUB", n="ru") => {
                    try {
                        return Ee(t, n).format(e)
                    } catch (n) {
                        return `${e} ${t}`
                    }
                }
                )(Se(this[ye].priceValue), this[ye].currency, null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.i18n.lang) : super.price
            }
            get priceValue() {
                return this[ye] ? String(Se(this[ye].priceValue)) : super.priceValue
            }
            get[pe]() {
                var e, t;
                return this[ye] ? `/${this[ye].currency.toLowerCase()}` : (null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.moneyCodeSymbol) ? `/${null == (t = window.YandexGamesSDKEnvironment) ? void 0 : t.moneyCodeSymbol.toLowerCase()}` : ""
            }
            get[me]() {
                return (0,
                ke.o)()
            ...
            getCatalog() {
                return new Promise(( (e, t) => {
                    ...
                    l.F.postToParent(i.yH.GetCatalog({
                        ...
                        De("get-catalog result", t),
                        e(t.products.map((e => new Ae(e))))
                    }
                    )).catch((e => {
                        t(e)
                    }
            ...
            getPurchases() {
                return new Promise(( (e, t) => {
                    ...
                    l.F.postToParent(i.yH.GetPurchases({
                        ...
                        De("getPurchases callback", t);
                        const r = t.map((e => new Oe({
                            productID: e.product.id,
                            purchaseToken: e.token,
                            developerPayload: e.developerPayload
                        })));
        ...
        let Ce = () => (window.YandexGamesSDKEnvironment || (0,
        m.f)(new Error("SDK environment: `window.YandexGamesSDKEnvironment` is undefined")),
        Ce = () => window.YandexGamesSDKEnvironment || xe,
        Ce());
        const _e = {
            get app() {
                return Ce().app
            ...
            get payload() {
                return Ce().params.payload
            },
            get isTelegram() {
                return Ce().isTelegram
            },
            get domain() {
                return Ce().serviceName || Ce().serviceHostname
            }
        };
        var Le = n(31);
        function Re(e) {
        ...
        l.F.onExternalMessage("auth", (e => {
            if ("changed" === e.data.action && Ve) {
                Ne("Call onLogoutCallback()");
                try {
                    Ve()
                } catch (e) {
                    console.error()
        ...
        class Ye extends M {
            constructor(e, t) {
                ...
                this.getPlayerData = () => {
                    return e = this,
                    t = function*() {
                        const {data: e} = yield l.F.postToParent(i.Uh.GetData({
                ...
                ,
                this.getDataPromise = () => void 0 !== this.data ? Promise.resolve(this.data) : _e.isTelegram ? (W("getData", {
                    key: q
                }),
                new Promise(( (e, t) => {
                    function n(r) {
                ...
                ))).catch(( () => this.getPlayerData())) : this.getApiPromise(),
                this.config = t,
                Be && Be.isSamePlayer(this.getUniqueID()) || (Be = new Fe(this.getUniqueID()))
            }
            onLogout(e) {
                Ne("Set onLogout callback"),
                Ve = e
            }
            getIDsPerGame() {
            ...
            getData(e) {
                return this.dataPromise = this.getDataPromise(),
                this.dataPromise.then((t => je(t, e)))
            }
            setData(e, t=!1) {
                var n;
                if (_e.isTelegram && (n = e,
                W("setData", {
                    key: q,
            ...
            getStats(e) {
                return void 0 === this.statsPromise && (this.statsPromise = new Promise(( (e, t) => {
                    l.F.postToParent(i.Uh.Stats({
                        signed: this.config.signed
                    })).then(( ({data: e}) => Ge(e))).then(e).catch(t).finally(( () => this.statsPromise = void 0))
                }
                ))),
                this.statsPromise.then((t => je(t, e)))
            }
            setStats(e) {
                return Me(e) ? l.F.postToParent(i.Uh.SetStats({
                    stats: e
                })).then(( ({data: e}) => e.result)) : Promise.reject(new Error("Stats is not valid"))
            }
            incrementStats(e) {
                return Me(e) ? l.F.postToParent(i.Uh.IncrementStats({
                    increments: e,
                    signed: this.config.signed
                })).then(( ({data: e}) => Ge(e.result))) : Promise.reject(new Error("Increments is not valid"))
            }
        }
        function He(e) {
            return t = this,
        ...
        const We = Ke || function() {
          ...
          , qe = /iPad|iPhone|iPod/.test(navigator.platform)
          , Xe = /^((?!chrome|android).)*safari/i.test(navigator.userAgent)
          , Je = qe || Xe
          , ze = /app-[^.]+\.games\.s3\.yandex\.net$/.test(location.hostname)
          , Qe = !ze && Je
          , Ze = function(e, t) {
            ...
            (0,
            m.f)(new Error("localStorage is broken on iOS/MacOS - https://developer.apple.com/forums/thread/109909\nPlease use YaGames.init().then(ysdk => ysdk.getStorage()).then(storage => storage.setItem('key', 'value'))"))
        }
        ))
          , et = class e {
            static setup() {
                Qe && Object.defineProperty(window, "localStorage", {
                    get: function() {
                        return Ze(),
                        We
                    }
                }),
                Je && ze && e.setProxy() && e.backup()
            }
            static load() {
                if (e.onloadPromise_)
                    return e.onloadPromise_;
                const t = e.getCustomLocalStorage();
                return t ? (e.onloadPromise_ = Promise.race([He(5e3).then(( () => {
                    throw new Error("LocalStorage timeout")
                }
                )), l.F.postToParent(i.Qq.GetAll()).then(( ({data: e}) => {
                    for (let[n,r] of Object.entries(e))
                        t.setItem(n, String(r));
                    return t
                }
                ))]).catch((e => (console.error(e),
                We))),
                e.onloadPromise_) : Promise.resolve(We)
            }
            static getCustomLocalStorage() {
                return "function" != typeof Proxy ? null : new Proxy({
                    clear() {
                        We.clear.call(We),
                        l.F.postToParent(i.Qq.Clear())
                    },
                    getItem: e => We.getItem.call(We, e),
                    key: e => We.key.call(We, e),
                    get length() {
                        return We.length
                    },
                    removeItem(e) {
                        We.removeItem.call(We, e),
                        l.F.postToParent(i.Qq.Del(e))
                    },
                    setItem(e, t) {
                        We.setItem.call(We, e, String(t)),
        ...
        ;
        et.onloadPromise_ = null;
        let tt = et;
        function nt() {
            return !Je && Ke ? Promise.resolve(Ke) : tt.load()
        }
        var rt = Object.defineProperty
          , at = Object.getOwnPropertySymbols
          , ot = Object.prototype.hasOwnProperty
          , st = Object.prototype.propertyIsEnumerable
          , it = (e, t, n) => t in e ? rt(e, t, {
            enumerable: !0,
            configurable: !0,
            writable: !0,
            value: n
        ...
        var dt = Object.defineProperty
          ...
          , ft = (e, t) => {
            for (var n in t || (t = {}))
                mt.call(t, n) && yt(e, n, t[n]);
            if (pt)
                for (var n of pt(t))
                    gt.call(t, n) && yt(e, n, t[n]);
            return e
        }
          , vt = (e, t) => ut(e, ht(t))
          , wt = (e, t, n) => new Promise(( (r, a) => {
            var o = e => {
                try {
                    i(n.next(e))
                } catch (e) {
        ...
        const bt = () => ({
          ...
          , Pt = class {
            constructor(e) {
                this.getCatalog = () => wt(this, null, (function*() {
                    var e;
                    const {data: t} = yield l.F.postToParent(i.Aw.Catalog(bt()));
                    return (null != (e = null == t ? void 0 : t.bonuses) ? e : []).map(lt)
                }
                )),
                this.getPlayerBonuses = () => wt(this, null, (function*() {
                    const {data: e} = yield l.F.postToParent(i.Aw.PlayerBonuses(vt(ft({}, bt()), {
                        signed: this.signed
                    })));
                    return this.signed ? e : e ? e.map((e => vt(ft({}, lt(e.item)), {
        ...
        ;
        Pt.init = e => {
            const {getCatalog: t, getPlayerBonuses: n, consume: r} = new Pt(e);
            return {
                getCatalog: t,
                getPlayerBonuses: n,
                consume: r
        ...
        function Tt() {
            ...
            if (St("captureUnityAlert isUnity", e),
            e && (document.querySelectorAll("div[style]:not([id]):not([class])").forEach(kt),
        ...
        const xt = function({matchers: e, updateErrorTitle: t=It}) {
            return function(n) {
                for (const r of e)
                    if (r.regexp && -1 !== n.search(r.regexp) || r.substr && n.includes(r.substr))
                        return {
        ...
        var Ct = Object.defineProperty
          ...
          , Nt = (e, t) => {
            for (var n in t || (t = {}))
                Lt.call(t, n) && Ft(e, n, t[n]);
            if (_t)
                for (var n of _t(t))
                    Rt.call(t, n) && Ft(e, n, t[n]);
            return e
        }
        ;
        function $t(e, t) {
        ...
        const jt = new class {
            ...
            _unsafeHandlePromiseRejectionEvent(e) {
                ...
                "[object Event]" === r ? r = "event.type: " + n.type : "[object Object]" === r && (a.unhandledObject = n,
                ...
                console.error(o.message, R.X4, o),
                this._postError(o, "unhandled")
            }
            _unsafeHandleErrorEvent(e, t) {
                ...
                (this.additionalErrorData || (null == i ? void 0 : i.additional)) && (c.additional = Nt(Nt({}, null == i ? void 0 : i.additional), this.additionalErrorData)),
                console.error(c.message, R.X4, c),
                this._postError(c, t)
            }
            _trimErrorData(e, t) {
        ...
        function() {
            try {
                ...
                console.error = (...t) => {
                    ...
                    try {
                        "string" == typeof t[1] && t[1] === R.X4 ? t.splice(1, 1) : $t(Gt(n), "console.error")
                    } catch (e) {}
                    e.apply(console, t)
                }
            } catch (e) {
        ...
        const Mt = h("Events bus", "Dev", {
          ...
          , Wt = (e, t) => {
            Mt(`[notifyObservers]: {${e}}`, ...t ? [t] : []),
            Ut.notifyObservers(Array.isArray(e) ? e : [e], t)
        }
        ;
        l.F.onExternalMessage(Bt, ( ({data: {action: e, data: t}}) => Wt(e, t)));
        const qt = h("Gameplay | Child frame", "Dev", {
            background: "#6c5b7b",
            text: "#ffffff"
        })
          , Xt = e => {
          ...
          , Jt = new Set;
        let zt = !1;
        const Qt = "function" != typeof Proxy ? e => e : (e, t, n) => zt ? e : new Proxy(e,{
            get: (e, r) => ("symbol" != typeof r && !zt && t.includes(r) && Jt.add(`${n}.${r}`),
            e[r])
        })
          , Zt = () => {
            zt || (l.F.postToParent((0,
            i.Iq)(Array.from(Jt).join(","))),
            Jt.clear(),
            zt = !0)
        }
        ;
        var en;
        const tn = "/helpers/fake-page/1/index.html"
          , nn = Symbol("promises");
        en = nn;
        let rn = class e {
            constructor() {
            ...
            getAllGames() {
                const e = this[nn].get("all");
                if (e)
                    return e;
                const t = y("getAllGames")
                  , n = new Promise(( (e, n) => l.F.postToParent(i.Rh.All()).then(( ({data: t}) => {
                    var n;
                    (null == (n = window.YandexGamesSDKEnvironment) ? void 0 : n.useMockGameLinks) && (t.games.forEach((e => e.url = `${tn}`)),
                    t.developerURL = `${tn}`),
                    e(t)
                }
                )).catch((e => {
                ...
                return this[nn].set("all", n),
                n
            }
            getGameByID(e) {
                const t = this[nn].get(`${e}`);
                if (t)
                    return t;
                const n = y("getGameByID")
                  , r = new Promise(( (t, r) => l.F.postToParent(i.Rh.Game(e)).then(( ({data: e}) => {
                    var n;
                    (null == (n = window.YandexGamesSDKEnvironment) ? void 0 : n.useMockGameLinks) && e.game && (e.game.url = `${tn}`),
                    t(e)
                }
                )).catch((t => {
                    this[nn].delete(`${e}`),
                ...
                return this[nn].set(`${e}`, r),
                r
            }
        }
        ;
        rn.instance = Qt(new rn, ["getGameByID", "getAllGames"], "GamesAPI");
        const an = rn.instance
          , on = class e {
            constructor() {
                this.isReady = !1,
        ...
        class dn {
            constructor(e={}) {
                this[cn] = an;
                for (let t in c.VR)
                    c.VR[t]in e && e[c.VR[t]] && (this[t] = new ln[t]);
                for (let t of c.Hn)
                    !this[t] && (t in e && e[t] || !(t in e)) && (this[t] = new ln[t]);
                l.F.postToParent((0,
                i.OI)(c.ur.GameInit))
            }
        }
        ...
        cn = c.VR.GamesAPI;
        var un = (e => (e.GAME_RATED = "GAME_RATED",
        e.NO_AUTH = "NO_AUTH",
        ...
        const hn = new class {
            canReview() {
                return new Promise((e => {
                    ...
                    l.F.postToParent(i.E0.CanReview()).then(( ({data: t}) => {
                        e(t)
                    }
                    )).catch((t => {
                        (0,
            ...
            requestReview() {
                return new Promise((e => {
                    ...
                    l.F.postToParent(i.E0.RequestReview()).then(( ({data: t}) => {
        ...
        function yn() {
            const e = []
              , t = {
                ...
                webgl: pn(document.createElement("canvas")),
                webgl2: mn(document.createElement("canvas"))
            };
        ...
        function vn(...e) {
            ...
            return e.reduce(( (e, n) => (Object.keys(n).forEach((r => {
                const a = e[r]
                  , o = n[r];
                Array.isArray(a) && Array.isArray(o) ? e[r] = a.concat(...o) : t(a) && t(o) ? e[r] = vn(a, o) : e[r] = o
            }
            )),
            e)), {})
        }
        function wn(e, t={}) {
            var n, r, a;
            return (null == (r = null == (n = window.YandexGamesSDKEnvironment) ? void 0 : n.request.experiments) ? void 0 : r.signed) && (t.signed = !0),
            function(e) {
            ...
            "object" == typeof (a = t) && Object.keys(a).forEach((e => {
                "signed" !== e && (0,
                m.f)(new Error(`Using deprecated key in YaGames.init options: ${e}`))
            }
            )),
            function(e={}) {
                return function(e) {
                    "adv"in e && F.sendOnceDeprecatedUsage("SDK init options with adv"),
                    e.adv = e.adv || {},
                    function(e) {
        ...
        function kn() {
            ...
            n = function*(e={}) {
                var t;
                const n = null == (t = Sn.getFor(e)) ? void 0 : t.promise;
                if (n)
                    return n;
                ...
                i.HT)({
                    ...
                    const {data: n, signature: r} = t
                      , o = function(e, t, n) {
                        const r = new Ye(t,e);
                        return oe(r, n),
                        Qt(r, ["getPayingStatus", "getStats", "getData", "getName"], "Player")
                    }(e, n, r);
                    a.resolve(o)
                }
                )).catch((t => {
        ...
        l.F.onExternalMessage("auth", (e => {
            ["auth-dialog-cancel", "auth-dialog-success", "changed"].includes(e.data.action) && (En("Clear getPlayer promises."),
            Sn.clear())
        }
        ));
        class Tn {
        ...
        class An {
            constructor() {
                this.fullscreen = new Tn
            }
        }
        var On = n(881);
        const Dn = Date.now()
          , In = `id_cursorHighlighter_${Dn}`
          , xn = `cursorHighlighter_${Dn}`
          , Cn = `active_${Dn}`
          , _n = {
            [c.q1.EXIT]: !0
        }
        ...
        function Rn(e) {
            ...
            Cache.prototype[e] = function(e, n) {
                ...
                Ln.some((e => -1 !== r.indexOf(e)))) ? Promise.resolve() : ("ignoreSearch"in (n = n || {}) || (n.ignoreSearch = !0),
                t.call(this, e, n));
                var r
            }
        }
          ...
          , Nn = new class {
            canShowPrompt() {
                return new Promise((e => {
                    ...
                    l.F.postToParent(i.lW.CanShowPrompt()).then(( ({data: t}) => {
                        e(t)
                    }
                    )).catch((e => {
                        (0,
            ...
            showPrompt() {
                return new Promise((e => {
                    ...
                    l.F.postToParent(i.lW.ShowPrompt()).then(( ({data: t}) => {
                        e(t)
                    }
                    )).catch((e => {
                        (0,
        ...
        !function() {
            var e;
            if (D())
                St("alert hook disabled");
            else
                try {
                    "function" == typeof window.alert && (e = window.alert,
                    window.alert = function() {
                        const t = arguments[0];
                        return St(`alert message = ${t}`),
                        l.F.postToParent((0,
                        i.Bz)({
        ...
        const Vn = Un(void 0, null, (function*() {
            ...
            ( () => {
                ...
                if (!/(games\.s3\.yandex\.net|games-storage(-awst?)?\.yandex\.net)$/.test(t))
                    return;
                const r = (0,
                ke.o)();
                if (!r)
                    return;
                let a;
                a = /games\.s3\.yandex\.net$/.test(t) ? `https://yandex.ru/games/app/${r}${n}${e}` : `https://yandex.com/games/app/${r}${n}${e}`,
            ...
            window.loadEnvironmentPromise = window.loadEnvironmentPromise || new Promise(( (e, t) => {
                ...
                l.F.postToParent((0,
                i.VT)()).then(( ({data: t}) => {
                    G.sdkBackendURL = String(t.enviroment.sdkBackendURL),
                    Object.freeze(G),
                    delete t.enviroment.sdkBackendURL,
                    e(t)
                }
                )).catch((e => {
                    t(e)
                ...
                const t = !("enviroment"in e && "options"in e)
                  , n = t ? e : e.enviroment;
                return window.YandexGamesSDKEnvironment = n,
                Bn("APP_VERSION", n.APP_VERSION),
                !t && e.options
            }
            )),
            function() {
                const e = s(( () => l.F.postToParent((0,
                i.Vw)())), 2e3);
        ...
        class Hn {
            constructor(e) {
                ...
                ,
                this.onEvent = (e, t) => (console.warn("Deprecated usage of `ysdk.onEvent`, please use `ysdk.on(...)` instead."),
                Yt(e, t)),
                this.achievements = P.init(),
                this.adv = Qt(new C(e), ["showBannerAdv"], "AdvManager"),
                this.analytics = {
                    yaMetrikaCounter: Qt(new Mn, ["hit", "reachGoal"], "YaMetrikaCounter")
                },
                this.auth = _,
                this.bonuses = Et.init(e.signed),
                this.clipboard = At,
                this.deviceInfo = new Ot(e.deviceType),
                qn.deviceInfo = this.deviceInfo,
                this.environment = (e => {
                    if (!new URLSearchParams(location.search).get("debug-mode") || "function" != typeof Proxy)
                        return e;
                    ...
                    return Object.defineProperty(t, "i18n", {
                        get() {
                            const t = e.i18n;
                            return new Proxy(t,{
                                get: (e, t) => ("lang" === t && l.F.postToParent(Le.i.I18n()),
                                e[t])
                            })
                        }
                    }),
                    ...
                    const t = y("isAvailableMethod")
                      , r = l.F.postToParent(i.sC.CheckAvailability({
                        ...
                        const a = {
                            ...
                            payments: Ie,
                            player: Ye,
                            storage: tt.getCustomLocalStorage()
                        }
                          , o = e.split(".");
                        let s = ct(ct({}, a), n);
                ...
                this.getPlayer = kn,
                this.getStorage = nt,
                this.notifications = fn,
                this.screen = new An,
                this.features = Qt(new dn(e.features), [c.VR.GameplayAPI, c.VR.LoadingAPI], "FeatureManager"),
                this.yandexApp = {
        ...
        try {
            Yn = new URLSearchParams(location.hash.slice(1)).get("device-type")
        } catch (e) {}
        class qn {
            constructor() {
            ...
            static longtaskObserver() {
                ...
                "complete" === document.readyState ? l.F.postToParent((0,
                i.X0)()) : window.addEventListener("load", ( () => {
                    l.F.postToParent((0,
                    i.X0)())
                }
                ))
            ...
            static init(e) {
                return Un(this, null, (function*() {
                    let t = location.hash;
                    try {
                        const e = yield Un(void 0, null, (function*() {
                            let e;
                            try {
                                e = yield(t = function*() {
                                    return new Promise(( (e, t) => {
                                        ...
                                        window.addEventListener("message", (function t(a) {
                                            ...
                                            o && o.messageId === n && (window.removeEventListener("message", t),
                                            clearTimeout(r),
                                            e(o.payload))
                                        }
                                        )),
                                ...
                                new Promise(( (e, n) => {
                                    var r = e => {
                                      ...
                                      , o = t => t.done ? e(t.value) : Promise.resolve(t.value).then(r, a);
                    ...
                    return Kn ? (console.warn("YaGames was initialized"),
                    Kn) : (this.longtaskObserver(),
                    Bn("Start initialization"),
                    yield Vn,
                    Kn = new Promise(( (n, r) => {
                        !function() {
                            const e = () => {
                        ...
                        const a = a => {
                            try {
                                ...
                                $n().then(( () => {
                                    ...
                                    window.setTimeout(Zt, 6e4),
                                    n(Qt(e, ["auth", "getFlags", "getLeaderboards", "getPayments", "getStorage", "serverTime"], "SDK")),
                                    function() {
                                        if (!new URLSearchParams(location.search).get("debug-mode"))
                                            return;
                                        const e = e => {
                                            const {altKey: t, code: n, ctrlKey: r, key: a, metaKey: o, shiftKey: s} = e;
                                            l.F.postToParent(On.C.Keydown({
                                                keydown: {
                                                    altKey: t,
                                                    code: n,
                                                    ctrlKey: r,
                                          ...
                                          , {startHighlighting: t, stopHighlighting: n} = (e => {
                                            let t;
                                            e || ( () => {
                                                if (document.head.querySelector(`#${In}`))
                                                    return;
                                            ...
                                            const s = document.createElement("div")
                                              , {activeClass: i=Cn, mainClass: c=xn} = null != e ? e : {};
                                            s.classList.add(c),
                                            ...
                                            const l = (e, t) => {
                                              ...
                                              , d = ({button: e, pageX: n, pageY: r}) => {
                                                clearTimeout(t),
                                                o = !0,
                                                s.classList.add(i),
                                                s.dataset.button = String(e),
                                                l(n, r)
                                            }
                                              , u = ({pageX: e, pageY: t}) => {
                                                o && l(e, t)
                                              ...
                                              , h = () => {
                                                t = setTimeout(( () => s.classList.remove(i)), 250),
                                                o = !1
                                            }
                                            ;
                                            return {
                                                startHighlighting: () => {
                                                    ...
                                                    document.addEventListener("onblur", h)
                                                }
                                                ,
                                                stopHighlighting: () => {
                                                    ...
                                                    document.removeEventListener("onblur", h),
                                                    s.classList.remove(i)
                                                }
                                            }
                                        }
                                        )();
                                        l.F.onExternalMessage(c.cV, ( ({data: {action: r}}) => {
                                            switch (r) {
                                            case "start":
                                                t(),
                        ...
                        setTimeout(( () => {
                            ...
                            Bn("checkAndSendGameInfo tech data:", e),
                            Wn(( () => {
                                l.F.postToParent((0,
                                i.cp)(e))
                            }
                    ...
                    Kn.then(( () => Bn("Initialized"))),
                    Kn)
                }
                ))
            }
        }
        if (qn.deviceInfo = new Ot(Yn),
        window.YaGames && window.YaGamesAdded) {
            ...
            if (window.parent !== window) {
                const e = (0,
                i.ce)();
                console.info(`SDK Init. Version: ${e.data.sdkVersion}. Is loader: ${e.data.isSdkLoader}.`),
                l.F.postToParent(e)
            }
            try {
                tt.setup()
            ...
            window.top !== window && $n().then((function() {
            ...
            Fn.overrideCacheSearch(),
            "SecurityPolicyViolationEvent"in window ? window.addEventListener("securitypolicyviolation", ( ({blockedURI: e, columnNumber: t, disposition: n, documentURI: r, effectiveDirective: a, lineNumber: o, originalPolicy: s, referrer: c, sample: d, sourceFile: u, statusCode: h, violatedDirective: p}) => {
                l.F.postToParent((0,
                i.TT)({
                    blockedURI: e,
                    columnNumber: t,
...
//# sourceMappingURL=https://s3.mdst.yandex.net/games/source-maps/_/sdk/client/sdk-v2/production/v2.921317a6f2b6a65a8441.js.map
